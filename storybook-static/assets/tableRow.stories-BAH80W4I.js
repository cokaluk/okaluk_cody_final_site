...
import { d as R } from "./styled-components.browser.esm-Dxl9SFvD.js";
import { T as a } from "./tableCell-DpJwDz4v.js";
const w = R.tr`
...
`,
  i = ({ disabled: e = !1, backgroundColor: m, cells: p }) => {
    ...
    return l.jsx(w, { disabled: e, backgroundColor: m, children: u });
  };
i.__docgenInfo = {
  description: "",
  methods: [],
...
const g = {
  ...
  o = {
    args: {
      disabled: !0,
      cells: [
        l.jsx(a, { text: "Disabled Row 1, Col 1" }, 1),
        l.jsx(a, { text: "Disabled Row 1, Col 2" }, 1),
        l.jsx(a, { text: "Disabled Row 1, Col 3" }, 1),
      ],
    },
  },
  t = {
    args: {
      disabled: !1,
      cells: [
        l.jsx(a, { text: "Enabled Row 1, Col 1" }, 1),
        l.jsx(a, { text: "Enabled Row 1, Col 2" }, 1),
        l.jsx(a, { text: "Enabled Row 1, Col 3" }, 1),
      ],
    },
  };
var s, r, n;
o.parameters = {
  ...
  args: {
    ...
    cells: [<TableCell key={1} text="Disabled Row 1, Col 1" />, <TableCell key={1} text="Disabled Row 1, Col 2" />, <TableCell key={1} text="Disabled Row 1, Col 3" />]
      ...
      ...((n = (r = o.parameters) == null ? void 0 : r.docs) == null
        ? void 0
        : n.source),
    },
  },
...
t.parameters = {
  ...
  args: {
    ...
    cells: [<TableCell key={1} text="Enabled Row 1, Col 1" />, <TableCell key={1} text="Enabled Row 1, Col 2" />, <TableCell key={1} text="Enabled Row 1, Col 3" />]
      ...
      ...((b = (c = t.parameters) == null ? void 0 : c.docs) == null
        ? void 0
        : b.source),
    },
  },
...
export { o as Disabled, t as Enabled, k as __namedExportsOrder, g as default };
